...
export const REALTORS_MESSAGES_PAGE_API =
  (realtorsId: string, page: number, sort: string) =>
    `${BASE_URL_API}/realtors/${realtorsId}/messages/?page=${page.toString()}&sort=date%3A${sort}`;
